window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/extensions/ui-cordis/src/client/CordisRunRow.module.css.mjs
		const css$2 = ".K_0Ghq_card{flex-direction:column;gap:8px;display:flex}.K_0Ghq_row{align-items:center;min-height:32px;display:flex}.K_0Ghq_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}.K_0Ghq_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}.K_0Ghq_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}.K_0Ghq_summary,.K_0Ghq_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}.K_0Ghq_error{color:var(--dsw-alias-state-error-primary)}.K_0Ghq_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}.K_0Ghq_card[data-cordis-status=awaiting-approval] .K_0Ghq_status,.K_0Ghq_card[data-cordis-status=client-pending] .K_0Ghq_status{color:var(--dsw-alias-state-warn-label)}.K_0Ghq_card[data-cordis-status=running] .K_0Ghq_status{color:var(--dsw-alias-state-success-primary)}.K_0Ghq_card[data-cordis-status=failed] .K_0Ghq_status{color:var(--dsw-alias-state-error-primary)}.K_0Ghq_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}.K_0Ghq_card:hover .K_0Ghq_inspect,.K_0Ghq_inspect:focus-visible{opacity:1}.K_0Ghq_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}.K_0Ghq_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}.K_0Ghq_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}.K_0Ghq_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}.K_0Ghq_business .K_0Ghq_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"status": "K_0Ghq_status",
			"inspect": "K_0Ghq_inspect",
			"separator": "K_0Ghq_separator",
			"title": "K_0Ghq_title",
			"business": "K_0Ghq_business",
			"summary": "K_0Ghq_summary",
			"icon": "K_0Ghq_icon",
			"row": "K_0Ghq_row",
			"error": "K_0Ghq_error",
			"message": "K_0Ghq_message",
			"output": "K_0Ghq_output",
			"card": "K_0Ghq_card"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/extensions/ui-cordis/src/client/CordisDefineRow.module.css.mjs
		const css$1 = ".cPK5CG_card{flex-direction:column;display:flex}.cPK5CG_card .cPK5CG_title,.cPK5CG_card .cPK5CG_chevron{color:var(--dsw-alias-state-business-primary)}.cPK5CG_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.cPK5CG_row{gap:0}.cPK5CG_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.cPK5CG_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.cPK5CG_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.cPK5CG_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.cPK5CG_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.cPK5CG_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.cPK5CG_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.cPK5CG_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.cPK5CG_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.cPK5CG_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.cPK5CG_switch{height:22px;padding:0 8px;font-size:12px}.cPK5CG_card[data-terminal] .cPK5CG_title,.cPK5CG_card[data-terminal] .cPK5CG_name,.cPK5CG_card[data-terminal] .cPK5CG_purpose,.cPK5CG_card[data-terminal] .cPK5CG_statusLabel{color:var(--dsw-alias-label-caption)}.cPK5CG_card[data-terminal] .cPK5CG_separator{background:var(--dsw-alias-label-caption)}.cPK5CG_bodyWrap{flex-direction:column;display:flex}.cPK5CG_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.cPK5CG_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}.cPK5CG_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.cPK5CG_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.cPK5CG_sourceTab:disabled{cursor:default;opacity:.4}.cPK5CG_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.cPK5CG_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.cPK5CG_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.cPK5CG_sourcePanel{max-height:260px;overflow:auto}.cPK5CG_sourceCode{margin:0}.cPK5CG_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.cPK5CG_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.cPK5CG_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.cPK5CG_output[data-error]{color:var(--dsw-alias-state-error-primary)}.cPK5CG_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.cPK5CG_card:hover .cPK5CG_inspectButton,.cPK5CG_inspectButton:focus-visible{opacity:1}.cPK5CG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.cPK5CG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.cPK5CG_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"chevron": "cPK5CG_chevron",
			"inspectButton": "cPK5CG_inspectButton",
			"sourceTabActive": "cPK5CG_sourceTabActive",
			"sourcePanel": "cPK5CG_sourcePanel",
			"title": "cPK5CG_title",
			"sectionLabel": "cPK5CG_sectionLabel",
			"output": "cPK5CG_output",
			"codeSection": "cPK5CG_codeSection",
			"visuallyHidden": "cPK5CG_visuallyHidden",
			"sourceTab": "cPK5CG_sourceTab",
			"purpose": "cPK5CG_purpose",
			"notice": "cPK5CG_notice",
			"bodyWrap": "cPK5CG_bodyWrap",
			"separator": "cPK5CG_separator",
			"readout": "cPK5CG_readout",
			"requestError": "cPK5CG_requestError",
			"panelHint": "cPK5CG_panelHint",
			"switch": "cPK5CG_switch",
			"errorSummary": "cPK5CG_errorSummary",
			"statusLabel": "cPK5CG_statusLabel",
			"row": "cPK5CG_row",
			"sourceCard": "cPK5CG_sourceCard",
			"sourceTabs": "cPK5CG_sourceTabs",
			"sourceCode": "cPK5CG_sourceCode",
			"name": "cPK5CG_name",
			"card": "cPK5CG_card",
			"approvalPrompt": "cPK5CG_approvalPrompt"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/extensions/ui-cordis/src/client/CordisPanel.module.css.mjs
		const css = ".FSYKPq_layer{flex:none;align-items:center;width:100%;height:49px;margin:8px 0 0;display:flex;position:relative}.FSYKPq_footerButtons{align-items:center;width:100%;display:flex}.FSYKPq_badge{width:100%;height:49px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:0 8px 0 6px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.FSYKPq_badge:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.FSYKPq_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.FSYKPq_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.FSYKPq_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.FSYKPq_layer.FSYKPq_rail{width:36px;height:36px;margin:0}.FSYKPq_rail .FSYKPq_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.FSYKPq_rail .FSYKPq_footerButtons{flex-direction:column;gap:2px}.FSYKPq_panel{z-index:30;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv2);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;bottom:128px;left:12px;overflow:hidden}.FSYKPq_header{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.FSYKPq_body{flex:1;min-height:0;padding:4px 12px 12px;overflow-y:auto}.FSYKPq_title{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500;line-height:20px}.FSYKPq_note,.FSYKPq_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.FSYKPq_readError{color:var(--dsw-alias-state-error-primary)}.FSYKPq_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0 4px;font-size:11px;font-weight:500;line-height:16px}.FSYKPq_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.FSYKPq_row{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.FSYKPq_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.FSYKPq_rowHead{align-items:center;gap:8px;display:flex}.FSYKPq_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.FSYKPq_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.FSYKPq_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.FSYKPq_row[data-cordis-status=idle] .FSYKPq_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.FSYKPq_row[data-cordis-status=awaiting-approval] .FSYKPq_rowStatus,.FSYKPq_row[data-cordis-status=client-pending] .FSYKPq_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.FSYKPq_row[data-cordis-status=failed] .FSYKPq_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.FSYKPq_row[data-cordis-status=running] .FSYKPq_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.FSYKPq_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.FSYKPq_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.FSYKPq_versionPicker select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;border-radius:7px;flex:1;padding:0 8px}.FSYKPq_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.FSYKPq_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.FSYKPq_rowActions{flex:none;align-items:center;gap:10px;display:flex}.FSYKPq_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.FSYKPq_transitionActions{gap:6px;margin-left:auto;display:flex}.FSYKPq_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.FSYKPq_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.FSYKPq_transitionActions button:disabled{opacity:.4;cursor:default}.FSYKPq_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.FSYKPq_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.FSYKPq_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.FSYKPq_actionButton:disabled{opacity:.4;cursor:default}.FSYKPq_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.FSYKPq_doubleCheck svg{position:absolute;top:1px}.FSYKPq_doubleCheck svg:first-child{opacity:.7;left:0}.FSYKPq_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"rowStatus": "FSYKPq_rowStatus",
			"versionPicker": "FSYKPq_versionPicker",
			"rowDetail": "FSYKPq_rowDetail",
			"rows": "FSYKPq_rows",
			"rowError": "FSYKPq_rowError",
			"readError": "FSYKPq_readError",
			"actionButton": "FSYKPq_actionButton",
			"header": "FSYKPq_header",
			"note": "FSYKPq_note",
			"footerButtons": "FSYKPq_footerButtons",
			"rowPurpose": "FSYKPq_rowPurpose",
			"transitionActions": "FSYKPq_transitionActions",
			"body": "FSYKPq_body",
			"group": "FSYKPq_group",
			"title": "FSYKPq_title",
			"rowActions": "FSYKPq_rowActions",
			"badgeCount": "FSYKPq_badgeCount",
			"rowHead": "FSYKPq_rowHead",
			"layer": "FSYKPq_layer",
			"badge": "FSYKPq_badge",
			"rowId": "FSYKPq_rowId",
			"transition": "FSYKPq_transition",
			"badgeLabel": "FSYKPq_badgeLabel",
			"rowName": "FSYKPq_rowName",
			"panel": "FSYKPq_panel",
			"row": "FSYKPq_row",
			"activeVersion": "FSYKPq_activeVersion",
			"rail": "FSYKPq_rail",
			"doubleCheck": "FSYKPq_doubleCheck"
		};
		//#endregion
