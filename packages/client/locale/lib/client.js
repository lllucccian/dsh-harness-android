window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/locale/src/client/LanguageRow.module.css.mjs
		const css = ".bOgssq_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.bOgssq_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.bOgssq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.bOgssq_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.bOgssq_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.bOgssq_chevron{flex:none}";
		...
		var LanguageRow_module_css_default = {
			"row": "bOgssq_row",
			"rowText": "bOgssq_rowText",
			"title": "bOgssq_title",
			"selector": "bOgssq_selector",
			"chevron": "bOgssq_chevron"
		};
		//#endregion
