window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-model-selection/src/client/ModelSelect.module.css.mjs
		const css = ".FmKoQa_root{min-width:0;position:relative}.FmKoQa_trigger{min-width:0;max-width:220px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.FmKoQa_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.FmKoQa_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.FmKoQa_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.FmKoQa_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.FmKoQa_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.FmKoQa_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.FmKoQa_chevronOpen{transform:rotate(180deg)}.FmKoQa_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:min(240px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.FmKoQa_status,.FmKoQa_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.FmKoQa_error,.FmKoQa_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.FmKoQa_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.FmKoQa_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.FmKoQa_groups{min-height:0;overflow-y:auto}.FmKoQa_group+.FmKoQa_group{margin-top:4px}.FmKoQa_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.FmKoQa_option{width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.FmKoQa_option:hover:not(:disabled),.FmKoQa_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.FmKoQa_selected{background:0 0}.FmKoQa_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.FmKoQa_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.FmKoQa_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.FmKoQa_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.FmKoQa_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.FmKoQa_cell{width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.FmKoQa_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.FmKoQa_cellLabel{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.FmKoQa_cellValue{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:0 auto;overflow:hidden}.FmKoQa_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"cellChevron": "FmKoQa_cellChevron",
			"cellLabel": "FmKoQa_cellLabel",
			"selected": "FmKoQa_selected",
			"groups": "FmKoQa_groups",
			"status": "FmKoQa_status",
			"option": "FmKoQa_option",
			"cellValue": "FmKoQa_cellValue",
			"chevron": "FmKoQa_chevron",
			"warning": "FmKoQa_warning",
			"modelName": "FmKoQa_modelName",
			"triggerEffort": "FmKoQa_triggerEffort",
			"root": "FmKoQa_root",
			"triggerLabel": "FmKoQa_triggerLabel",
			"error": "FmKoQa_error",
			"retry": "FmKoQa_retry",
			"groupTitle": "FmKoQa_groupTitle",
			"empty": "FmKoQa_empty",
			"optionCopy": "FmKoQa_optionCopy",
			"check": "FmKoQa_check",
			"description": "FmKoQa_description",
			"cell": "FmKoQa_cell",
			"group": "FmKoQa_group",
			"menu": "FmKoQa_menu",
			"chevronOpen": "FmKoQa_chevronOpen",
			"trigger": "FmKoQa_trigger"
		};
		//#endregion
