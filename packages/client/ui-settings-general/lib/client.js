window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-settings-general/src/client/SettingsRoot.module.css.mjs
		const css$3 = ".aYfriq_trigger{box-sizing:border-box;cursor:pointer;width:calc(100% + 8px);height:34px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:none;align-items:center;gap:8px;margin:4px -4px;padding:6px 2px 6px 10px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}.aYfriq_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}.aYfriq_trigger.aYfriq_rail{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;margin:8px 0 10px;padding:0}.aYfriq_triggerLabel{white-space:nowrap;overflow:hidden}.aYfriq_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.aYfriq_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.aYfriq_panel{z-index:1;background:var(--dsw-alias-bg-layer-2);width:800px;max-width:calc(100vw - 48px);height:min(800px,100vh - 48px);box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:24px;display:flex;position:relative;overflow:hidden}.aYfriq_nav{box-sizing:border-box;flex-direction:column;flex:none;gap:18px;width:188px;padding:22px 12px 0;display:flex}.aYfriq_navTitle{color:var(--dsw-alias-label-primary);padding:0 12px;font-size:16px;font-weight:500;line-height:24px}.aYfriq_navList{flex-direction:column;gap:4px;display:flex}.aYfriq_navCell{box-sizing:border-box;cursor:pointer;height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:9px 16px 9px 12px;font-family:inherit;font-size:14px;font-weight:400;line-height:22px;display:flex}.aYfriq_navCell:hover{background:var(--dsw-specific-sidebar-nav-item-hover)}.aYfriq_navCell.aYfriq_active{background:var(--dsw-specific-sidebar-nav-item-active)}.aYfriq_navIcon{flex:none}.aYfriq_navLabel{white-space:nowrap;text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}.aYfriq_content{flex-direction:column;flex:1;min-width:0;display:flex}.aYfriq_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:20px 14px 8px 10px;display:flex}.aYfriq_actions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;margin-left:auto;display:flex}.aYfriq_close{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}.aYfriq_close:hover{background:var(--dsw-alias-interactive-bg-hover)}.aYfriq_options{flex:1;min-height:0;padding:0 24px 24px;overflow-y:auto}.aYfriq_hiddenLabel{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var SettingsRoot_module_css_default = {
			"mask": "aYfriq_mask",
			"hiddenLabel": "aYfriq_hiddenLabel",
			"navCell": "aYfriq_navCell",
			"close": "aYfriq_close",
			"navList": "aYfriq_navList",
			"active": "aYfriq_active",
			"panel": "aYfriq_panel",
			"triggerLabel": "aYfriq_triggerLabel",
			"navIcon": "aYfriq_navIcon",
			"options": "aYfriq_options",
			"navLabel": "aYfriq_navLabel",
			"rail": "aYfriq_rail",
			"trigger": "aYfriq_trigger",
			"overlay": "aYfriq_overlay",
			"navTitle": "aYfriq_navTitle",
			"header": "aYfriq_header",
			"nav": "aYfriq_nav",
			"actions": "aYfriq_actions",
			"content": "aYfriq_content"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-settings-general/src/client/chrome.module.css.mjs
		const css$2 = "._KE54G_triggerLabel{white-space:nowrap;overflow:hidden}";
		...
		var chrome_module_css_default = { "triggerLabel": "_KE54G_triggerLabel" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-settings-general/src/client/GeneralSection.module.css.mjs
		const css$1 = ".Dv0L6W_section{flex-direction:column;width:100%;display:flex}.Dv0L6W_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		...
		var GeneralSection_module_css_default = { "section": "Dv0L6W_section" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-settings-general/src/client/SettingsDocumentAction.module.css.mjs
		const css = ".K0edvq_action{align-items:center;gap:8px;min-width:0;display:flex}.K0edvq_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
