window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-user-questions/src/client/PlanReviewPanel.module.css.mjs
		const css$1 = ".s8zo8a_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.s8zo8a_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}.s8zo8a_card,.s8zo8a_card *{box-sizing:border-box}.s8zo8a_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}.s8zo8a_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}.s8zo8a_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}.s8zo8a_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}.s8zo8a_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}.s8zo8a_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}.s8zo8a_discuss{color:var(--dsw-alias-label-secondary);gap:6px}.s8zo8a_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){.s8zo8a_card{border-radius:16px}.s8zo8a_body{padding:10px 12px 4px}.s8zo8a_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			"actions": "s8zo8a_actions",
			"body": "s8zo8a_body",
			"footer": "s8zo8a_footer",
			"feedback": "s8zo8a_feedback",
			"frame": "s8zo8a_frame",
			"card": "s8zo8a_card",
			"dot": "s8zo8a_dot",
			"discuss": "s8zo8a_discuss",
			"strip": "s8zo8a_strip"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-user-questions/src/client/QuestionComposer.module.css.mjs
		const css = ".dnZO4a_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.dnZO4a_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.dnZO4a_card,.dnZO4a_card *{box-sizing:border-box}.dnZO4a_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.dnZO4a_headingBlock{min-width:0}.dnZO4a_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.dnZO4a_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.dnZO4a_detail{margin:0 2px 8px}.dnZO4a_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.dnZO4a_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.dnZO4a_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.dnZO4a_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.dnZO4a_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.dnZO4a_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.dnZO4a_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.dnZO4a_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.dnZO4a_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.dnZO4a_option:hover:not(:disabled),.dnZO4a_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.dnZO4a_optionSelected{border-color:var(--dsw-alias-border-l2)}.dnZO4a_option:disabled{cursor:default}.dnZO4a_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.dnZO4a_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.dnZO4a_checkbox:before{content:\"\";border:1px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.dnZO4a_checkbox>svg{grid-area:1/1}.dnZO4a_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.dnZO4a_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.dnZO4a_optionCopy{flex:1;min-width:0}.dnZO4a_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.dnZO4a_optionLabel{font-size:14px;font-weight:500;line-height:24px}.dnZO4a_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.dnZO4a_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.dnZO4a_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.dnZO4a_customRow:hover,.dnZO4a_customRow:focus-within,.dnZO4a_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.dnZO4a_customRow:focus-within,.dnZO4a_customRowActive{border-color:var(--dsw-alias-border-l2)}.dnZO4a_customInput{min-width:0;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;background:0 0;border:none;outline:none;flex:1;padding:0;font-size:14px;line-height:24px}.dnZO4a_customInput::placeholder{color:var(--dsw-alias-label-caption)}.dnZO4a_customTextarea{resize:none;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);min-height:64px;max-height:140px;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;border-radius:10px;outline:none;flex-shrink:0;margin:0 12px;padding:8px 12px;font-size:14px;line-height:24px;display:block}.dnZO4a_customTextarea:focus{border-color:var(--dsw-alias-state-business-primary)}.dnZO4a_customTextarea::placeholder{color:var(--dsw-alias-label-caption)}.dnZO4a_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.dnZO4a_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.dnZO4a_card{border-radius:16px}.dnZO4a_header{padding:10px 12px 0 18px}.dnZO4a_options{padding:4px 8px}.dnZO4a_title{font-size:15px;line-height:21px}.dnZO4a_option,.dnZO4a_customRow{padding:8px 6px}.dnZO4a_footer{align-items:flex-end;padding:0 10px}.dnZO4a_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.dnZO4a_option,.dnZO4a_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			"frame": "dnZO4a_frame",
			"body": "dnZO4a_body",
			"header": "dnZO4a_header",
			"pager": "dnZO4a_pager",
			"detail": "dnZO4a_detail",
			"customRowActive": "dnZO4a_customRowActive",
			"headingBlock": "dnZO4a_headingBlock",
			"progress": "dnZO4a_progress",
			"customInput": "dnZO4a_customInput",
			"optionSelected": "dnZO4a_optionSelected",
			"customRow": "dnZO4a_customRow",
			"checkboxChecked": "dnZO4a_checkboxChecked",
			"optionLine": "dnZO4a_optionLine",
			"badge": "dnZO4a_badge",
			"customTextarea": "dnZO4a_customTextarea",
			"eyebrow": "dnZO4a_eyebrow",
			"number": "dnZO4a_number",
			"checkbox": "dnZO4a_checkbox",
			"footer": "dnZO4a_footer",
			"optionLabel": "dnZO4a_optionLabel",
			"description": "dnZO4a_description",
			"option": "dnZO4a_option",
			"title": "dnZO4a_title",
			"footerActions": "dnZO4a_footerActions",
			"optionCopy": "dnZO4a_optionCopy",
			"card": "dnZO4a_card",
			"iconButton": "dnZO4a_iconButton",
			"options": "dnZO4a_options",
			"feedback": "dnZO4a_feedback"
		};
		//#endregion
