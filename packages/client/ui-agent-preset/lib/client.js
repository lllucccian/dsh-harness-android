window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-agent-preset/src/client/AgentPresetLabel.module.css.mjs
		const css$3 = ".aOcGKq_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}.aOcGKq_icon{opacity:.7;flex:none}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-agent-preset/src/client/AgentPresetRow.module.css.mjs
		const css$2 = "._6Yn7WW_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}._6Yn7WW_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}._6Yn7WW_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}._6Yn7WW_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}._6Yn7WW_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}._6Yn7WW_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}._6Yn7WW_selector:disabled{cursor:default}._6Yn7WW_chevron{flex:none}";
		...
		var AgentPresetRow_module_css_default = {
			"row": "_6Yn7WW_row",
			"selector": "_6Yn7WW_selector",
			"chevron": "_6Yn7WW_chevron",
			"title": "_6Yn7WW_title",
			"rowText": "_6Yn7WW_rowText",
			"desc": "_6Yn7WW_desc"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-agent-preset/src/client/AgentPresetSeat.module.css.mjs
		const css$1 = "._3P_dnq_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}._3P_dnq_seat:not(:disabled):hover,._3P_dnq_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}._3P_dnq_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}._3P_dnq_seatIcon{color:var(--dsw-alias-label-primary);flex:none}._3P_dnq_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both _3P_dnq_seat-icon-in}@keyframes _3P_dnq_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}._3P_dnq_introText{white-space:pre;display:inline-block}._3P_dnq_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards _3P_dnq_seat-char-in;display:inline-block}@keyframes _3P_dnq_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){._3P_dnq_introIcon,._3P_dnq_introChar{opacity:1;animation:none}}._3P_dnq_chevron{color:var(--dsw-alias-label-caption);flex:none}._3P_dnq_item{flex-direction:column;gap:2px;max-width:280px;display:flex}._3P_dnq_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}._3P_dnq_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"item": "_3P_dnq_item",
			"introIcon": "_3P_dnq_introIcon",
			"chevron": "_3P_dnq_chevron",
			"seat-icon-in": "_3P_dnq_seat-icon-in",
			"seatIcon": "_3P_dnq_seatIcon",
			"itemName": "_3P_dnq_itemName",
			"introChar": "_3P_dnq_introChar",
			"seat": "_3P_dnq_seat",
			"introText": "_3P_dnq_introText",
			"itemDesc": "_3P_dnq_itemDesc",
			"seat-char-in": "_3P_dnq_seat-char-in"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-agent-preset/src/client/AgentPresetSection.module.css.mjs
		const css = ".-ZvQea_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.-ZvQea_title{margin:0;font-size:18px;font-weight:600}.-ZvQea_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.-ZvQea_group{flex-direction:column;gap:10px;display:flex}.-ZvQea_group+.-ZvQea_group{margin-top:20px}.-ZvQea_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.-ZvQea_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.-ZvQea_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.-ZvQea_card:hover:not(.-ZvQea_cardActive){border-color:var(--dsw-alias-label-dimmed)}.-ZvQea_cardActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-primary)}.-ZvQea_cardBroken,.-ZvQea_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.-ZvQea_brokenBadge{white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.-ZvQea_cardBrokenReason{color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;font-size:12px;line-height:1.5}.-ZvQea_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.-ZvQea_cardMain:disabled{cursor:default}.-ZvQea_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.-ZvQea_cardHead{align-items:center;gap:8px;display:flex}.-ZvQea_cardName{font-size:15px;font-weight:600;line-height:1.4}.-ZvQea_badge,.-ZvQea_inUse{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.-ZvQea_badge{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.-ZvQea_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.-ZvQea_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.-ZvQea_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-dimmed);margin-top:auto;font-size:11px}.-ZvQea_cardFoot{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.-ZvQea_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.-ZvQea_iconButton:disabled{opacity:.4;cursor:default}.-ZvQea_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.-ZvQea_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.-ZvQea_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.-ZvQea_iconButton:hover:after,.-ZvQea_iconButton:focus-visible:after{opacity:1}.-ZvQea_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.-ZvQea_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.-ZvQea_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.-ZvQea_revealedPathLabel{white-space:nowrap}.-ZvQea_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.-ZvQea_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.-ZvQea_secondaryButton:disabled{opacity:.5;cursor:default}.-ZvQea_field{flex-direction:column;gap:6px;display:flex}.-ZvQea_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.-ZvQea_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.-ZvQea_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.-ZvQea_input::placeholder{color:var(--dsw-alias-label-dimmed)}.-ZvQea_dialog{width:min(560px,100%)}.-ZvQea_dialogFields{flex-direction:column;gap:12px;display:flex}.-ZvQea_viewerCode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.-ZvQea_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.-ZvQea_deleteDialog{width:min(480px,100%)}.-ZvQea_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.-ZvQea_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.-ZvQea_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:12px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.-ZvQea_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.-ZvQea_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"title": "-ZvQea_title",
			"group": "-ZvQea_group",
			"secondaryButton": "-ZvQea_secondaryButton",
			"cardHead": "-ZvQea_cardHead",
			"card": "-ZvQea_card",
			"deleteConfirm": "-ZvQea_deleteConfirm",
			"viewerCode": "-ZvQea_viewerCode",
			"cardFoot": "-ZvQea_cardFoot",
			"cardName": "-ZvQea_cardName",
			"brokenBadge": "-ZvQea_brokenBadge",
			"revealedPathLabel": "-ZvQea_revealedPathLabel",
			"deleteDialog": "-ZvQea_deleteDialog",
			"cardMain": "-ZvQea_cardMain",
			"iconButton": "-ZvQea_iconButton",
			"input": "-ZvQea_input",
			"cards": "-ZvQea_cards",
			"revealedPath": "-ZvQea_revealedPath",
			"section": "-ZvQea_section",
			"cardDesc": "-ZvQea_cardDesc",
			"error": "-ZvQea_error",
			"cardBroken": "-ZvQea_cardBroken",
			"inUse": "-ZvQea_inUse",
			"fieldLabel": "-ZvQea_fieldLabel",
			"cardId": "-ZvQea_cardId",
			"iconDanger": "-ZvQea_iconDanger",
			"dialogFields": "-ZvQea_dialogFields",
			"intro": "-ZvQea_intro",
			"creatorButton": "-ZvQea_creatorButton",
			"cardBrokenReason": "-ZvQea_cardBrokenReason",
			"badge": "-ZvQea_badge",
			"dialog": "-ZvQea_dialog",
			"cardActive": "-ZvQea_cardActive",
			"field": "-ZvQea_field",
			"groupHead": "-ZvQea_groupHead"
		};
		//#endregion
