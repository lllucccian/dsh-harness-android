window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-skill/src/client/SkillRow.module.css.mjs
		const css = ".qgXIpW_card{flex-direction:column;display:flex}.qgXIpW_row{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.qgXIpW_row[data-expandable]{cursor:pointer}.qgXIpW_card[data-state=running] .qgXIpW_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite qgXIpW_dsh-skill-row-sweep;position:absolute;inset:0 auto 0 0}@keyframes qgXIpW_dsh-skill-row-sweep{0%{left:-300px}90%,to{left:100%}}.qgXIpW_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.qgXIpW_chevron{color:var(--dsw-alias-label-secondary)}.qgXIpW_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.qgXIpW_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.qgXIpW_row:hover .qgXIpW_iconIdle{opacity:0}.qgXIpW_row:hover .qgXIpW_chevronHover{opacity:1}.qgXIpW_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.qgXIpW_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.qgXIpW_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.qgXIpW_errorSummary{color:var(--dsw-alias-state-error-primary)}.qgXIpW_bodyWrap{flex-direction:column;display:flex}.qgXIpW_instructionsCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);border-radius:12px;flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:hidden}.qgXIpW_instructionsHeader{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block-banner);color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:8px 12px;font-size:11px;font-weight:500;line-height:16px}.qgXIpW_instructions{white-space:pre-wrap;overflow-wrap:anywhere;min-height:0;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);margin:0;padding:10px 12px 12px;overflow:auto}.qgXIpW_instructions[data-error]{color:var(--dsw-alias-state-error-primary)}.qgXIpW_instructions::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.qgXIpW_instructions::-webkit-scrollbar-track{margin:6px 0}.qgXIpW_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.qgXIpW_card:hover .qgXIpW_inspectButton,.qgXIpW_inspectButton:focus-visible{opacity:1}.qgXIpW_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.qgXIpW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.qgXIpW_card[data-state=running] .qgXIpW_row:after{animation:none;display:none}.qgXIpW_iconIdle,.qgXIpW_chevronHover,.qgXIpW_inspectButton{transition:none}}";
		...
		var SkillRow_module_css_default = {
			"row": "qgXIpW_row",
			"separator": "qgXIpW_separator",
			"bodyWrap": "qgXIpW_bodyWrap",
			"chevronHover": "qgXIpW_chevronHover",
			"iconIdle": "qgXIpW_iconIdle",
			"inspectButton": "qgXIpW_inspectButton",
			"dsh-skill-row-sweep": "qgXIpW_dsh-skill-row-sweep",
			"card": "qgXIpW_card",
			"summary": "qgXIpW_summary",
			"visuallyHidden": "qgXIpW_visuallyHidden",
			"instructionsCard": "qgXIpW_instructionsCard",
			"chevron": "qgXIpW_chevron",
			"instructions": "qgXIpW_instructions",
			"title": "qgXIpW_title",
			"leading": "qgXIpW_leading",
			"instructionsHeader": "qgXIpW_instructionsHeader",
			"errorSummary": "qgXIpW_errorSummary"
		};
		//#endregion
