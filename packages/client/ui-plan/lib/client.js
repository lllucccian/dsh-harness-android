window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-plan/src/client/PlanModeControl.module.css.mjs
		const css = "._2fLm4G_wrap{align-items:center;gap:6px;display:inline-flex}._2fLm4G_chip{background:var(--dsw-alias-state-warn-tertiary);min-width:34px;color:var(--dsw-alias-state-warn-label);cursor:pointer;border:none;border-radius:999px;align-items:center;gap:4px;padding:2px 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}._2fLm4G_chip:hover:not(:disabled){color:var(--dsw-alias-state-warn-primary)}._2fLm4G_chip:focus-visible{outline:2px solid var(--dsw-alias-state-warn-label);outline-offset:2px}._2fLm4G_chip:disabled{opacity:.6;cursor:default}._2fLm4G_close{color:currentColor;align-items:center;display:inline-flex}._2fLm4G_error{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}";
