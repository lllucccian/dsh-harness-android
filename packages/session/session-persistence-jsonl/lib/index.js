...
/** True when the environment forbids hardlinks (Android/Termux seccomp returns
*  EACCES; some sandboxes return EPERM/EOPNOTSUPP/ENOSYS). */
function isHardlinkBlocked(error) {
	const code = error?.code;
	return code === "EACCES" || code === "EPERM" || code === "EOPNOTSUPP" || code === "ENOSYS";
}
/**
