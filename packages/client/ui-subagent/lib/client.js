window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-subagent/src/client/SubagentCatalogAction.module.css.mjs
		const css$1 = ".C8URPq_root{position:relative}.C8URPq_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.C8URPq_count{margin:0 5px}.C8URPq_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.C8URPq_trigger:hover,.C8URPq_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.C8URPq_trigger svg{transition:transform .12s}.C8URPq_triggerOpen{transform:rotate(180deg)}.C8URPq_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.C8URPq_node{min-width:0;position:relative}.C8URPq_menu>.C8URPq_node{margin-left:-3px}.C8URPq_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.C8URPq_row:hover>.C8URPq_clickarea,.C8URPq_row:focus-visible>.C8URPq_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.C8URPq_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.C8URPq_row>[data-state],.C8URPq_clickarea>[data-state]{margin-top:4px}.C8URPq_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.C8URPq_disabled:hover{background:0 0}.C8URPq_loadingRow{cursor:default}.C8URPq_disclosure,.C8URPq_disclosureSpace{flex:none;width:14px;height:18px}.C8URPq_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.C8URPq_disclosure:hover{color:var(--dsw-alias-label-primary)}.C8URPq_disclosureOpen{transform:rotate(90deg)}.C8URPq_content{flex-direction:column;flex:1;min-width:0;display:flex}.C8URPq_label,.C8URPq_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.C8URPq_label{color:inherit;font-weight:400}.C8URPq_summary,.C8URPq_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.C8URPq_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.C8URPq_metricToken{grid-row:1;line-height:18px}.C8URPq_metricDuration{grid-row:2}.C8URPq_children{margin-left:18px;padding-left:4px;position:relative}.C8URPq_children:before,.C8URPq_children>.C8URPq_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}.C8URPq_children:before{height:26px;top:-26px}.C8URPq_children[aria-busy=true]:before{content:none}.C8URPq_children>.C8URPq_node:before{top:0;bottom:0;left:-4px}.C8URPq_children>.C8URPq_node:last-child:before{height:17px;bottom:auto}.C8URPq_children>.C8URPq_node>.C8URPq_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.C8URPq_notice,.C8URPq_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.C8URPq_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.C8URPq_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.C8URPq_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentCatalogAction_module_css_default = {
			"disclosure": "C8URPq_disclosure",
			"error": "C8URPq_error",
			"root": "C8URPq_root",
			"row": "C8URPq_row",
			"trigger": "C8URPq_trigger",
			"summary": "C8URPq_summary",
			"node": "C8URPq_node",
			"clickarea": "C8URPq_clickarea",
			"notice": "C8URPq_notice",
			"disclosureSpace": "C8URPq_disclosureSpace",
			"metricDuration": "C8URPq_metricDuration",
			"label": "C8URPq_label",
			"triggerOpen": "C8URPq_triggerOpen",
			"loadingRow": "C8URPq_loadingRow",
			"metricToken": "C8URPq_metricToken",
			"disclosureOpen": "C8URPq_disclosureOpen",
			"count": "C8URPq_count",
			"children": "C8URPq_children",
			"disabled": "C8URPq_disabled",
			"activitySlot": "C8URPq_activitySlot",
			"content": "C8URPq_content",
			"metrics": "C8URPq_metrics",
			"menu": "C8URPq_menu",
			"refresh": "C8URPq_refresh"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-subagent/src/client/SubagentReadOnlyComposer.module.css.mjs
		const css = ".snMYAW_frame{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-height:54px;color:var(--dsw-alias-label-tertiary);border-radius:14px;justify-content:center;align-items:center;gap:8px;margin:0 24px 20px;padding:10px 16px;font-size:13px;line-height:20px;display:flex}.snMYAW_frame strong{color:var(--dsw-alias-label-primary);font-weight:510}";
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "snMYAW_frame" };
		//#endregion
