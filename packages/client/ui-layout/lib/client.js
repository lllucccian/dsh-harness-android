window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-layout/src/client/AppFrame.module.css.mjs
		const css = ".qopC2W_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}.qopC2W_frame[data-dragging]{transition:none}@media (prefers-reduced-motion:reduce){.qopC2W_frame{transition:none}}.qopC2W_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:1px solid var(--dsw-alias-border-l1);min-width:0;overflow:hidden}.qopC2W_centerCol{flex-direction:column;min-width:0;display:flex;overflow:hidden}.qopC2W_detailsCol{border-left:1px solid var(--dsw-alias-border-l2);min-width:0;overflow:hidden}.qopC2W_frame[data-details-collapsed] .qopC2W_detailsCol{border-left:none}.qopC2W_handle{cursor:col-resize;z-index:2;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}.qopC2W_frame[data-dragging] .qopC2W_handle{transition:none}@media (prefers-reduced-motion:reduce){.qopC2W_handle{transition:none}}.qopC2W_handle[data-side=details]:after{content:\"\";box-sizing:border-box;background:var(--dsw-alias-button-floating-fill);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);opacity:0;width:12px;height:32px;transition:opacity var(--ds-transition-duration-slow) var(--ds-ease-in-out), background var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:10px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.qopC2W_detailsCol:hover~.qopC2W_handle[data-side=details]:after,.qopC2W_handle[data-side=details]:hover:after,.qopC2W_handle[data-side=details][data-dragging=true]:after{opacity:1}.qopC2W_handle[data-side=details]:hover:after,.qopC2W_handle[data-side=details][data-dragging=true]:after{background:var(--dsw-alias-button-floating-hover);border-color:var(--dsw-alias-border-l3)}.qopC2W_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}.qopC2W_overlayLayer>*{pointer-events:auto}";
		...
		var AppFrame_module_css_default = {
			"detailsCol": "qopC2W_detailsCol",
			"sidebarCol": "qopC2W_sidebarCol",
			"centerCol": "qopC2W_centerCol",
			"frame": "qopC2W_frame",
			"handle": "qopC2W_handle",
			"overlayLayer": "qopC2W_overlayLayer"
		};
		//#endregion
