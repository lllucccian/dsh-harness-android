window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-directory-picker-browse/src/client/DirectoryBrowser.module.css.mjs
		const css = ".u913sq_dialog.u913sq_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.u913sq_editorScope{display:contents}.u913sq_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.u913sq_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.u913sq_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.u913sq_crumbBar:has(.u913sq_crumbEditZone:enabled:hover),.u913sq_crumbBar:has(.u913sq_crumbEditZone:focus-visible),.u913sq_crumbBar:has(.u913sq_pathInput){border-color:var(--dsw-alias-border-l2)}.u913sq_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.u913sq_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.u913sq_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.u913sq_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.u913sq_crumb:hover{color:var(--dsw-alias-label-primary)}.u913sq_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.u913sq_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.u913sq_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.u913sq_crumbEditZone:enabled:hover .u913sq_crumbEditGlyph,.u913sq_crumbEditZone:focus-visible .u913sq_crumbEditGlyph{color:var(--dsw-alias-label-primary)}.u913sq_crumbEditZone:disabled{cursor:default}.u913sq_crumbEditZone:disabled .u913sq_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.u913sq_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.u913sq_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.u913sq_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.u913sq_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}.u913sq_rowSeat{flex:none;display:flex}.u913sq_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.u913sq_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.u913sq_rowSelected,.u913sq_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.u913sq_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.u913sq_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.u913sq_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.u913sq_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.u913sq_status,.u913sq_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.u913sq_status{color:var(--dsw-alias-label-secondary)}.u913sq_error{color:var(--dsw-alias-state-error-primary)}.u913sq_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.u913sq_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.u913sq_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.u913sq_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.u913sq_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.u913sq_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.u913sq_footerGap{flex:1 1 0}.u913sq_footerAction{min-width:72px}.u913sq_createDialog.u913sq_createDialog{gap:0;width:min(380px,100%);padding:0}.u913sq_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.u913sq_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.u913sq_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.u913sq_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.u913sq_createInput::placeholder{color:var(--dsw-alias-label-caption)}.u913sq_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"pathInput": "u913sq_pathInput",
			"crumbEditGlyph": "u913sq_crumbEditGlyph",
			"rowIconSelected": "u913sq_rowIconSelected",
			"loadingFloat": "u913sq_loadingFloat",
			"dialog": "u913sq_dialog",
			"content": "u913sq_content",
			"rowSelected": "u913sq_rowSelected",
			"createInput": "u913sq_createInput",
			"status": "u913sq_status",
			"editorScope": "u913sq_editorScope",
			"rowSeat": "u913sq_rowSeat",
			"rowName": "u913sq_rowName",
			"showHiddenToggle": "u913sq_showHiddenToggle",
			"row": "u913sq_row",
			"crumbBar": "u913sq_crumbBar",
			"title": "u913sq_title",
			"crumbChevron": "u913sq_crumbChevron",
			"createBody": "u913sq_createBody",
			"column": "u913sq_column",
			"showHiddenToggleActive": "u913sq_showHiddenToggleActive",
			"footerGap": "u913sq_footerGap",
			"rowIcon": "u913sq_rowIcon",
			"createIn": "u913sq_createIn",
			"crumbEditZone": "u913sq_crumbEditZone",
			"crumbTrail": "u913sq_crumbTrail",
			"footerAction": "u913sq_footerAction",
			"createDialog": "u913sq_createDialog",
			"rowChevron": "u913sq_rowChevron",
			"createTitle": "u913sq_createTitle",
			"crumbSeat": "u913sq_crumbSeat",
			"millerRow": "u913sq_millerRow",
			"createActions": "u913sq_createActions",
			"header": "u913sq_header",
			"crumb": "u913sq_crumb",
			"divider": "u913sq_divider",
			"error": "u913sq_error",
			"footerBar": "u913sq_footerBar"
		};
		//#endregion
