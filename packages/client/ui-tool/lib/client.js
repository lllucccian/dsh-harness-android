window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$3 = ".CLgF1G_root{flex-direction:column;display:flex}.CLgF1G_row{position:relative;overflow:hidden}.CLgF1G_root[data-state=running] .CLgF1G_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite CLgF1G_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes CLgF1G_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.CLgF1G_leading{flex-shrink:0}.CLgF1G_root[data-tool^=cordis_] .CLgF1G_leading,.CLgF1G_root[data-tool^=cordis_] .CLgF1G_title{color:var(--dsw-alias-state-business-primary)}.CLgF1G_root[data-tool^=cordis_] .CLgF1G_title{font-weight:500}.CLgF1G_root[data-tool^=cordis_] .CLgF1G_sep{background:var(--dsw-alias-state-business-primary)}.CLgF1G_chevron{color:var(--dsw-alias-label-secondary)}.CLgF1G_title{font-weight:400}.CLgF1G_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.CLgF1G_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.CLgF1G_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.CLgF1G_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.CLgF1G_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.CLgF1G_errorSummary{color:var(--dsw-alias-state-error-primary)}.CLgF1G_bodyWrap{flex-direction:column;display:flex}.CLgF1G_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.CLgF1G_root:hover .CLgF1G_inspectButton,.CLgF1G_inspectButton:focus-visible{opacity:1}.CLgF1G_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.CLgF1G_bodyScroll{max-height:260px;overflow-y:auto}.CLgF1G_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.CLgF1G_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.CLgF1G_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.CLgF1G_ioSection::-webkit-scrollbar-track{margin:6px 0}.CLgF1G_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.CLgF1G_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.CLgF1G_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.CLgF1G_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.CLgF1G_codeBody,.CLgF1G_terminalBody,.CLgF1G_diffBody,.CLgF1G_readBody,.CLgF1G_searchBody,.CLgF1G_webBody{margin:4px 0 4px 4px}.CLgF1G_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.CLgF1G_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.CLgF1G_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.CLgF1G_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"searchRecovery": "CLgF1G_searchRecovery",
			"ioLabel": "CLgF1G_ioLabel",
			"codeBody": "CLgF1G_codeBody",
			"readBody": "CLgF1G_readBody",
			"visuallyHidden": "CLgF1G_visuallyHidden",
			"leading": "CLgF1G_leading",
			"ioSection": "CLgF1G_ioSection",
			"title": "CLgF1G_title",
			"ioCard": "CLgF1G_ioCard",
			"dsh-tool-row-sweep": "CLgF1G_dsh-tool-row-sweep",
			"summary": "CLgF1G_summary",
			"summarySuffix": "CLgF1G_summarySuffix",
			"chevron": "CLgF1G_chevron",
			"bodyScroll": "CLgF1G_bodyScroll",
			"root": "CLgF1G_root",
			"row": "CLgF1G_row",
			"inspectButton": "CLgF1G_inspectButton",
			"ioText": "CLgF1G_ioText",
			"terminalBody": "CLgF1G_terminalBody",
			"bodyWrap": "CLgF1G_bodyWrap",
			"fileLink": "CLgF1G_fileLink",
			"ioDivider": "CLgF1G_ioDivider",
			"searchBody": "CLgF1G_searchBody",
			"webBody": "CLgF1G_webBody",
			"errorSummary": "CLgF1G_errorSummary",
			"sep": "CLgF1G_sep",
			"diffBody": "CLgF1G_diffBody"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$2 = ".N0uABW_callRow{border-radius:6px}.N0uABW_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"callRow": "N0uABW_callRow",
			"subCalls": "N0uABW_subCalls"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-tool/src/client/tool/ToolDetails.module.css.mjs
		const css$1 = ".JC_Sxq_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.JC_Sxq_cardBody{margin:0}.JC_Sxq_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.JC_Sxq_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.JC_Sxq_code[data-error]{color:var(--dsw-alias-state-error-primary)}.JC_Sxq_read,.JC_Sxq_web{margin:0}.JC_Sxq_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			"cardBody": "JC_Sxq_cardBody",
			"read": "JC_Sxq_read",
			"web": "JC_Sxq_web",
			"empty": "JC_Sxq_empty",
			"code": "JC_Sxq_code",
			"description": "JC_Sxq_description",
			"recovery": "JC_Sxq_recovery"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = "._7-kzca_card{flex-direction:column;display:flex}._7-kzca_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}._7-kzca_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}._7-kzca_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}._7-kzca_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}._7-kzca_ioSection::-webkit-scrollbar-track{margin:6px 0}._7-kzca_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}._7-kzca_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}._7-kzca_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}._7-kzca_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}._7-kzca_root[data-expandable]{cursor:pointer}._7-kzca_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}._7-kzca_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite _7-kzca_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes _7-kzca_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}._7-kzca_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}._7-kzca_chevron{color:var(--dsw-alias-label-secondary)}._7-kzca_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}._7-kzca_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}._7-kzca_root:hover ._7-kzca_iconIdle{opacity:0}._7-kzca_root:hover ._7-kzca_chevronHover{opacity:1}._7-kzca_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}._7-kzca_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._7-kzca_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}._7-kzca_errorSummary{color:var(--dsw-alias-state-error-primary)}._7-kzca_bodyWrap{flex-direction:column;display:flex}._7-kzca_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}._7-kzca_card:hover ._7-kzca_inspectButton,._7-kzca_inspectButton:focus-visible{opacity:1}._7-kzca_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}._7-kzca_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"title": "_7-kzca_title",
			"visuallyHidden": "_7-kzca_visuallyHidden",
			"ioSection": "_7-kzca_ioSection",
			"ioText": "_7-kzca_ioText",
			"ioLabel": "_7-kzca_ioLabel",
			"leading": "_7-kzca_leading",
			"card": "_7-kzca_card",
			"inspectButton": "_7-kzca_inspectButton",
			"bodyWrap": "_7-kzca_bodyWrap",
			"iconIdle": "_7-kzca_iconIdle",
			"terminal": "_7-kzca_terminal",
			"ioCard": "_7-kzca_ioCard",
			"chevron": "_7-kzca_chevron",
			"root": "_7-kzca_root",
			"sep": "_7-kzca_sep",
			"summary": "_7-kzca_summary",
			"ioDivider": "_7-kzca_ioDivider",
			"dsh-bash-row-sweep": "_7-kzca_dsh-bash-row-sweep",
			"chevronHover": "_7-kzca_chevronHover",
			"errorSummary": "_7-kzca_errorSummary"
		};
		//#endregion
