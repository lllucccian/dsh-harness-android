window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-settings-plugins/src/client/fields.module.css.mjs
		const css$2 = ".Xt_kTW_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.Xt_kTW_field+.Xt_kTW_field{border-top:1px solid var(--dsw-alias-border-l2)}.Xt_kTW_head{align-items:center;gap:8px;display:flex}.Xt_kTW_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.Xt_kTW_badges{align-items:center;gap:8px;display:inline-flex}.Xt_kTW_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.Xt_kTW_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.Xt_kTW_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.Xt_kTW_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.Xt_kTW_reset:disabled{cursor:default}.Xt_kTW_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.Xt_kTW_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.Xt_kTW_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.Xt_kTW_inputInvalid{border-color:var(--dsw-alias-label-error);}.Xt_kTW_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.Xt_kTW_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"reset": "Xt_kTW_reset",
			"field": "Xt_kTW_field",
			"inputInvalid": "Xt_kTW_inputInvalid",
			"input": "Xt_kTW_input",
			"head": "Xt_kTW_head",
			"invalid": "Xt_kTW_invalid",
			"badgeMuted": "Xt_kTW_badgeMuted",
			"badge": "Xt_kTW_badge",
			"label": "Xt_kTW_label",
			"hint": "Xt_kTW_hint",
			"badges": "Xt_kTW_badges"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-settings-plugins/src/client/PluginCard.module.css.mjs
		const css$1 = ".uYfH7W_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.uYfH7W_card:hover{border-color:var(--dsw-alias-label-dimmed)}.uYfH7W_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.uYfH7W_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.uYfH7W_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.uYfH7W_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.uYfH7W_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.uYfH7W_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.uYfH7W_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.uYfH7W_chevronOpen{transform:rotate(180deg)}.uYfH7W_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.uYfH7W_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.uYfH7W_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.uYfH7W_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.uYfH7W_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.uYfH7W_discard,.uYfH7W_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.uYfH7W_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.uYfH7W_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.uYfH7W_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.uYfH7W_discard:disabled,.uYfH7W_save:disabled{opacity:.4;cursor:default}.uYfH7W_discard:focus-visible,.uYfH7W_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"failed": "uYfH7W_failed",
			"body": "uYfH7W_body",
			"header": "uYfH7W_header",
			"headText": "uYfH7W_headText",
			"footer": "uYfH7W_footer",
			"pending": "uYfH7W_pending",
			"chevronOpen": "uYfH7W_chevronOpen",
			"name": "uYfH7W_name",
			"save": "uYfH7W_save",
			"cardOpen": "uYfH7W_cardOpen",
			"discard": "uYfH7W_discard",
			"chevron": "uYfH7W_chevron",
			"readOnly": "uYfH7W_readOnly",
			"card": "uYfH7W_card",
			"description": "uYfH7W_description"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-settings-plugins/src/client/PluginsSettingsSection.module.css.mjs
		const css = "._4OR4CG_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}._4OR4CG_heading{margin:0;font-size:18px;font-weight:600}._4OR4CG_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}._4OR4CG_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}._4OR4CG_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}._4OR4CG_tab:hover,._4OR4CG_tab[data-active=true]{color:var(--dsw-alias-label-primary)}._4OR4CG_tab[data-active=true]:after,._4OR4CG_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}._4OR4CG_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}._4OR4CG_panel{min-width:0;padding-top:2px}._4OR4CG_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}._4OR4CG_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"intro": "_4OR4CG_intro",
			"panel": "_4OR4CG_panel",
			"heading": "_4OR4CG_heading",
			"section": "_4OR4CG_section",
			"cards": "_4OR4CG_cards",
			"empty": "_4OR4CG_empty",
			"tabs": "_4OR4CG_tabs",
			"tab": "_4OR4CG_tab"
