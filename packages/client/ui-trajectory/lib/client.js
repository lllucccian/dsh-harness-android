window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-trajectory/src/client/TrajectoryTable.module.css.mjs
		const css$3 = ".IDJ_oq_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.IDJ_oq_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:IDJ_oq_trajectory-table/inline-size}.IDJ_oq_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.IDJ_oq_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.IDJ_oq_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite IDJ_oq_history-loading-spin}.IDJ_oq_table tbody .IDJ_oq_historyLoadRow td{height:30px;padding:0}.IDJ_oq_table tbody .IDJ_oq_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.IDJ_oq_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.IDJ_oq_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.IDJ_oq_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.IDJ_oq_historyLoadButton:disabled{cursor:default}.IDJ_oq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.IDJ_oq_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes IDJ_oq_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.IDJ_oq_historyLoadingSpinner{animation:none}}.IDJ_oq_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.IDJ_oq_eventColumn{width:122px}.IDJ_oq_contentColumn{width:auto}.IDJ_oq_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.IDJ_oq_eventHeader{text-align:right!important;padding-right:4px!important}.IDJ_oq_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.IDJ_oq_table tbody .IDJ_oq_virtualSpacer{pointer-events:none}.IDJ_oq_table tbody .IDJ_oq_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.IDJ_oq_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.IDJ_oq_table tbody tr[data-timeline-focus=outside]{opacity:.24}.IDJ_oq_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.IDJ_oq_table tbody tr[data-request-only=true]:hover{background:0 0}.IDJ_oq_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.IDJ_oq_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.IDJ_oq_table tbody tr[data-request-only=true] .IDJ_oq_turnRail{top:-15px;bottom:0}.IDJ_oq_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.IDJ_oq_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.IDJ_oq_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.IDJ_oq_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.IDJ_oq_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.IDJ_oq_requestBoundaryControl:hover:before,.IDJ_oq_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.IDJ_oq_requestBoundaryControlActive:before,.IDJ_oq_requestBoundaryControlActive:hover:before,.IDJ_oq_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.IDJ_oq_requestBoundaryControl[data-request-status=error]:before,.IDJ_oq_requestBoundaryControl[data-request-status=error]:hover:before,.IDJ_oq_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.IDJ_oq_requestBoundaryControl:hover:after,.IDJ_oq_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.IDJ_oq_requestBoundaryControl:focus-visible{outline:none}.IDJ_oq_table tbody tr:has(.IDJ_oq_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.IDJ_oq_event{position:relative}.IDJ_oq_turnRail,.IDJ_oq_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.IDJ_oq_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.IDJ_oq_table tbody tr[data-turn-end=true] .IDJ_oq_turnRail{bottom:0}.IDJ_oq_selectionRail{z-index:5;width:3px;top:0;bottom:0}.IDJ_oq_table tbody tr[data-error=true] .IDJ_oq_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.IDJ_oq_table tbody tr[data-error=true] .IDJ_oq_selectionRail{background:var(--dsw-alias-state-error-primary)}.IDJ_oq_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.IDJ_oq_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.IDJ_oq_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.IDJ_oq_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.IDJ_oq_turnLabelFull,.IDJ_oq_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.IDJ_oq_turnLabelCompact{opacity:0;max-width:0}.IDJ_oq_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.IDJ_oq_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.IDJ_oq_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.IDJ_oq_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}.IDJ_oq_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.IDJ_oq_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.IDJ_oq_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.IDJ_oq_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.IDJ_oq_table .IDJ_oq_kindSlot .IDJ_oq_message{justify-content:center;width:100%}@container IDJ_oq_trajectory-table (width<=620px){.IDJ_oq_eventColumn{width:50px}.IDJ_oq_event{padding-left:28px!important;padding-right:3px!important}.IDJ_oq_requestBoundaryControl{--request-boundary-base-left:6px}.IDJ_oq_kindSlot{width:19px}.IDJ_oq_kindTag,.IDJ_oq_table .IDJ_oq_kindSlot .IDJ_oq_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.IDJ_oq_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.IDJ_oq_kindTagLabel,.IDJ_oq_turnLabelFull{opacity:0;max-width:0}.IDJ_oq_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.IDJ_oq_eventColumn,.IDJ_oq_event,.IDJ_oq_requestBoundaryControl,.IDJ_oq_kindSlot,.IDJ_oq_kindTag,.IDJ_oq_kindTagIcon,.IDJ_oq_kindTagLabel,.IDJ_oq_turnLabelFull,.IDJ_oq_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.IDJ_oq_eventColumn,.IDJ_oq_kindSlot{transition-property:width}.IDJ_oq_event{transition-property:padding-right,padding-left}.IDJ_oq_requestBoundaryControl{transition-property:left}.IDJ_oq_kindTag{transition-property:padding-right,padding-left}.IDJ_oq_kindTagIcon{transition-property:width,opacity,transform}.IDJ_oq_kindTagLabel,.IDJ_oq_turnLabelFull,.IDJ_oq_turnLabelCompact{transition-property:max-width,opacity}}.IDJ_oq_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.IDJ_oq_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.IDJ_oq_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.IDJ_oq_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.IDJ_oq_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.IDJ_oq_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.IDJ_oq_promptDiffSection{min-width:0}.IDJ_oq_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.IDJ_oq_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.IDJ_oq_promptDiff span{min-width:max-content;padding:0 6px;display:block}.IDJ_oq_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.IDJ_oq_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.IDJ_oq_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.IDJ_oq_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.IDJ_oq_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.IDJ_oq_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.IDJ_oq_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.IDJ_oq_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.IDJ_oq_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.IDJ_oq_table tbody tr[data-collapsed-summary=turn] td,.IDJ_oq_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.IDJ_oq_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.IDJ_oq_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.IDJ_oq_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.IDJ_oq_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.IDJ_oq_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.IDJ_oq_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.IDJ_oq_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.IDJ_oq_resultRequest,.IDJ_oq_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.IDJ_oq_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.IDJ_oq_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.IDJ_oq_table tbody tr[data-kind=tool] .IDJ_oq_contentText,.IDJ_oq_table tbody tr[data-kind=subtool] .IDJ_oq_contentText,.IDJ_oq_table tbody tr[data-kind=tool] .IDJ_oq_resultPreview,.IDJ_oq_table tbody tr[data-kind=subtool] .IDJ_oq_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.IDJ_oq_table tbody tr[data-kind=subtool] .IDJ_oq_content{padding-left:26px}.IDJ_oq_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.IDJ_oq_noOutputText{color:var(--dsw-alias-label-caption)}.IDJ_oq_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.IDJ_oq_error,.IDJ_oq_overview dd.IDJ_oq_error,.IDJ_oq_details .IDJ_oq_errorPayload{color:var(--dsw-alias-state-error-primary)}.IDJ_oq_details .IDJ_oq_errorPayload .IDJ_oq_resultBlockText{color:inherit}.IDJ_oq_details .IDJ_oq_jsonPayload.IDJ_oq_errorPayload,.IDJ_oq_details .IDJ_oq_jsonPreview.IDJ_oq_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.IDJ_oq_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.IDJ_oq_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.IDJ_oq_detailsResizeHandle:focus-visible{outline:none}.IDJ_oq_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.IDJ_oq_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.IDJ_oq_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.IDJ_oq_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.IDJ_oq_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.IDJ_oq_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.IDJ_oq_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.IDJ_oq_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.IDJ_oq_detailTabs::-webkit-scrollbar{display:none}.IDJ_oq_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.IDJ_oq_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.IDJ_oq_detailTabActive{color:var(--dsw-alias-state-business-primary)}.IDJ_oq_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.IDJ_oq_close:focus-visible,.IDJ_oq_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.IDJ_oq_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.IDJ_oq_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.IDJ_oq_detailBodySummary>.IDJ_oq_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.IDJ_oq_detailBodySummary>.IDJ_oq_compactedSummary{flex:1;min-height:0;overflow:auto}.IDJ_oq_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.IDJ_oq_summaryScrollRegion:hover,.IDJ_oq_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.IDJ_oq_compactedSummary .IDJ_oq_markdownPayload{padding-right:18px}.IDJ_oq_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.IDJ_oq_overviewParentLinks{gap:14px;display:flex}.IDJ_oq_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.IDJ_oq_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.IDJ_oq_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.IDJ_oq_overviewHierarchyNavLink:hover .IDJ_oq_overviewHierarchyJumpIconTight,.IDJ_oq_overviewHierarchyNavLink:focus-visible .IDJ_oq_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.IDJ_oq_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.IDJ_oq_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.IDJ_oq_overview>.IDJ_oq_requestTokenDetail dt{padding-left:12px}.IDJ_oq_usagePanel{padding:4px 0 10px}.IDJ_oq_usageGroup+.IDJ_oq_usageGroup{margin-top:8px}.IDJ_oq_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.IDJ_oq_usageGroup .IDJ_oq_overview{padding:0}.IDJ_oq_overview dt{color:var(--dsw-alias-label-tertiary)}.IDJ_oq_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.IDJ_oq_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.IDJ_oq_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.IDJ_oq_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.IDJ_oq_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.IDJ_oq_overviewSection+.IDJ_oq_overviewSection{padding-top:8px}.IDJ_oq_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.IDJ_oq_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.IDJ_oq_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.IDJ_oq_overviewTitle:hover .IDJ_oq_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.IDJ_oq_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.IDJ_oq_overviewTitle:focus-visible .IDJ_oq_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.IDJ_oq_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.IDJ_oq_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.IDJ_oq_overviewPreview .IDJ_oq_jsonPreview>:first-child,.IDJ_oq_overviewPreview .IDJ_oq_schemaTree>:first-child{padding-bottom:0}.IDJ_oq_overviewPreview .IDJ_oq_schemaTree{margin-bottom:0}.IDJ_oq_overviewPreview .IDJ_oq_overview{padding:2px 0 0}.IDJ_oq_overviewPreview .IDJ_oq_overview>div{min-height:22px}.IDJ_oq_markdownPreview,.IDJ_oq_markdownPayload{color:var(--dsw-alias-label-primary)}.IDJ_oq_markdownPreview>div,.IDJ_oq_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.IDJ_oq_markdownPreview>div h1,.IDJ_oq_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.IDJ_oq_markdownPreview>div h2,.IDJ_oq_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.IDJ_oq_markdownPreview>div :where(h3,h4,h5,h6),.IDJ_oq_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.IDJ_oq_markdownPreview>div :not(pre)>code,.IDJ_oq_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.IDJ_oq_markdownPreview>div table,.IDJ_oq_markdownPayload>div table{font:var(--dsw-font-xs-13)}.IDJ_oq_markdownPreview>div>:first-child{margin-top:0}.IDJ_oq_markdownPreview>div>:last-child{margin-bottom:0}.IDJ_oq_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.IDJ_oq_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.IDJ_oq_markdownPreview>div :where(p,ul,ol){margin:8px 0}.IDJ_oq_markdownPreview>div li:not(:first-child){margin-top:3px}.IDJ_oq_markdownPreview>div blockquote{margin-top:8px}.IDJ_oq_markdownPreview>div hr{margin:14px 0}.IDJ_oq_markdownPreview>div>.md-code-block{margin:10px 0}.IDJ_oq_assistantContent .IDJ_oq_markdownPayload,.IDJ_oq_assistantContent .IDJ_oq_payload{min-height:0}.IDJ_oq_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.IDJ_oq_thinkingQuoteOnlyPreview{margin-bottom:8px}.IDJ_oq_detailBody>.IDJ_oq_assistantContentRendered .IDJ_oq_thinkingQuote{margin-top:14px}.IDJ_oq_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.IDJ_oq_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.IDJ_oq_thinkingToggle[aria-expanded=true] .IDJ_oq_thinkingChevron{transform:rotate(90deg)}.IDJ_oq_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.IDJ_oq_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.IDJ_oq_thinkingQuote .IDJ_oq_markdownPreview,.IDJ_oq_thinkingQuote .IDJ_oq_markdownPayload,.IDJ_oq_thinkingQuote .IDJ_oq_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.IDJ_oq_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.IDJ_oq_markdownPreview{padding:6px 14px 8px}.IDJ_oq_markdownPayload{min-height:100%;padding:14px}.IDJ_oq_jsonPayload{min-height:100%}.IDJ_oq_jsonPreview{min-height:0}.IDJ_oq_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.IDJ_oq_schemaPreview{min-height:0}.IDJ_oq_schemaIntro{padding:12px 14px 6px}.IDJ_oq_schemaPreview .IDJ_oq_schemaIntro{padding-top:6px}.IDJ_oq_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.IDJ_oq_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.IDJ_oq_schemaParameters{min-width:0}.IDJ_oq_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.IDJ_oq_schemaTree{margin:0 6px 8px 0}.IDJ_oq_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.IDJ_oq_payloadPreview{min-height:0;padding:6px 14px 8px}.IDJ_oq_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.IDJ_oq_sourceBlock+.IDJ_oq_sourceBlock{margin-top:14px}.IDJ_oq_sourceBlockHeader,.IDJ_oq_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.IDJ_oq_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.IDJ_oq_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.IDJ_oq_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.IDJ_oq_sourceBlockJumpTarget:hover .IDJ_oq_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.IDJ_oq_sourceBlockJumpTarget:focus-visible{outline:none}.IDJ_oq_sourceBlockJumpTarget:focus-visible .IDJ_oq_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.IDJ_oq_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.IDJ_oq_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}.IDJ_oq_panelImageLinkPreview{max-height:140px}.IDJ_oq_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}.IDJ_oq_panelImageLinkPreview .IDJ_oq_panelImage{max-height:140px}.IDJ_oq_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.IDJ_oq_messageImagesPreview{gap:6px;margin:6px 14px 8px}.IDJ_oq_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.IDJ_oq_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.IDJ_oq_assistantToolCalls li{min-width:0}.IDJ_oq_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.IDJ_oq_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.IDJ_oq_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.IDJ_oq_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.IDJ_oq_assistantToolCallButton:hover .IDJ_oq_assistantToolCallIcon,.IDJ_oq_assistantToolCallButton:focus-visible .IDJ_oq_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.IDJ_oq_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.IDJ_oq_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.IDJ_oq_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.IDJ_oq_systemPrompt{box-sizing:border-box}.IDJ_oq_toolCatalog{min-height:100%;padding:8px 0 16px}.IDJ_oq_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.IDJ_oq_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.IDJ_oq_toolCatalogSummary::-webkit-details-marker{display:none}.IDJ_oq_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.IDJ_oq_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.IDJ_oq_toolCatalogChevron,.IDJ_oq_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.IDJ_oq_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.IDJ_oq_toolCatalogItem[open] .IDJ_oq_toolCatalogChevron{transform:rotate(90deg)}.IDJ_oq_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.IDJ_oq_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.IDJ_oq_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.IDJ_oq_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.IDJ_oq_toolCatalogTree{margin-left:-14px;margin-right:6px}.IDJ_oq_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.IDJ_oq_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.IDJ_oq_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.IDJ_oq_overviewPreview .IDJ_oq_noPayload{padding:6px 14px 8px}.IDJ_oq_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.IDJ_oq_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"kindTagIcon": "IDJ_oq_kindTagIcon",
			"detailsHeader": "IDJ_oq_detailsHeader",
			"schemaTree": "IDJ_oq_schemaTree",
			"turnLabelFull": "IDJ_oq_turnLabelFull",
			"promptDiffTitle": "IDJ_oq_promptDiffTitle",
			"turnLabelCompact": "IDJ_oq_turnLabelCompact",
			"payloadPreview": "IDJ_oq_payloadPreview",
			"sourceBlockHeader": "IDJ_oq_sourceBlockHeader",
			"thinkingToggle": "IDJ_oq_thinkingToggle",
			"close": "IDJ_oq_close",
			"promptDiffLinecontext": "IDJ_oq_promptDiffLinecontext",
			"overviewTitle": "IDJ_oq_overviewTitle",
			"assistantToolCallArgs": "IDJ_oq_assistantToolCallArgs",
			"eventColumn": "IDJ_oq_eventColumn",
			"collapsedTurnText": "IDJ_oq_collapsedTurnText",
			"kindSlot": "IDJ_oq_kindSlot",
			"markdownPreview": "IDJ_oq_markdownPreview",
			"resultBlocks": "IDJ_oq_resultBlocks",
			"toolCatalogTree": "IDJ_oq_toolCatalogTree",
			"assistantToolCallIcon": "IDJ_oq_assistantToolCallIcon",
			"schema": "IDJ_oq_schema",
			"assistantVioletBright": "IDJ_oq_assistantVioletBright",
			"visuallyHidden": "IDJ_oq_visuallyHidden",
			"kindTagLabel": "IDJ_oq_kindTagLabel",
			"toolCatalogName": "IDJ_oq_toolCatalogName",
			"historyLoadingBar": "IDJ_oq_historyLoadingBar",
			"resultBlockText": "IDJ_oq_resultBlockText",
			"overviewSections": "IDJ_oq_overviewSections",
			"error": "IDJ_oq_error",
			"historyLoading": "IDJ_oq_historyLoading",
			"assistantToolCallButton": "IDJ_oq_assistantToolCallButton",
			"thinkingChevron": "IDJ_oq_thinkingChevron",
			"usagePanel": "IDJ_oq_usagePanel",
			"usageGroup": "IDJ_oq_usageGroup",
			"sourceBlock": "IDJ_oq_sourceBlock",
			"timestampToggle": "IDJ_oq_timestampToggle",
			"subtoolAmber": "IDJ_oq_subtoolAmber",
			"requestBoundaryControlActive": "IDJ_oq_requestBoundaryControlActive",
			"compacted": "IDJ_oq_compacted",
			"arrow": "IDJ_oq_arrow",
			"table": "IDJ_oq_table",
			"promptDiffLineadded": "IDJ_oq_promptDiffLineadded",
			"requestTokenDetail": "IDJ_oq_requestTokenDetail",
			"overviewHeading": "IDJ_oq_overviewHeading",
			"schemaParameters": "IDJ_oq_schemaParameters",
			"schemaParametersTitle": "IDJ_oq_schemaParametersTitle",
			"toolCatalog": "IDJ_oq_toolCatalog",
			"noOutputText": "IDJ_oq_noOutputText",
			"overviewPreview": "IDJ_oq_overviewPreview",
			"thinkingQuoteOnlyPreview": "IDJ_oq_thinkingQuoteOnlyPreview",
			"promptDiffSection": "IDJ_oq_promptDiffSection",
			"toolCatalogChevron": "IDJ_oq_toolCatalogChevron",
			"toolCatalogItem": "IDJ_oq_toolCatalogItem",
			"tablePane": "IDJ_oq_tablePane",
			"schemaName": "IDJ_oq_schemaName",
			"history-loading-spin": "IDJ_oq_history-loading-spin",
			"message": "IDJ_oq_message",
			"assistantOutput": "IDJ_oq_assistantOutput",
			"toolCatalogIcon": "IDJ_oq_toolCatalogIcon",
			"user": "IDJ_oq_user",
			"toolCallPayload": "IDJ_oq_toolCallPayload",
			"collapsedTurnEllipsis": "IDJ_oq_collapsedTurnEllipsis",
			"toolCatalogFullDescription": "IDJ_oq_toolCatalogFullDescription",
			"messageImagesPreview": "IDJ_oq_messageImagesPreview",
			"detailsTitle": "IDJ_oq_detailsTitle",
			"panelImage": "IDJ_oq_panelImage",
			"turnLabel": "IDJ_oq_turnLabel",
			"content": "IDJ_oq_content",
			"systemNeutral": "IDJ_oq_systemNeutral",
			"toolCallOnly": "IDJ_oq_toolCallOnly",
			"promptDiffLinemeta": "IDJ_oq_promptDiffLinemeta",
			"detailBody": "IDJ_oq_detailBody",
			"requestBoundaryControl": "IDJ_oq_requestBoundaryControl",
			"assistantContent": "IDJ_oq_assistantContent",
			"systemPrompt": "IDJ_oq_systemPrompt",
			"panelImageLink": "IDJ_oq_panelImageLink",
			"collapsedTurnContent": "IDJ_oq_collapsedTurnContent",
			"usageHeading": "IDJ_oq_usageHeading",
			"payload": "IDJ_oq_payload",
			"resultPreview": "IDJ_oq_resultPreview",
			"inlineResultText": "IDJ_oq_inlineResultText",
			"contextGreen": "IDJ_oq_contextGreen",
			"schemaIntro": "IDJ_oq_schemaIntro",
			"sourceBlockJumpIcon": "IDJ_oq_sourceBlockJumpIcon",
			"markdownPayload": "IDJ_oq_markdownPayload",
			"eventHeader": "IDJ_oq_eventHeader",
			"detailsResizeHandle": "IDJ_oq_detailsResizeHandle",
			"toolAmber": "IDJ_oq_toolAmber",
			"detailTab": "IDJ_oq_detailTab",
			"contentText": "IDJ_oq_contentText",
			"promptDiffSections": "IDJ_oq_promptDiffSections",
			"historyLoadButton": "IDJ_oq_historyLoadButton",
			"assistantContentRendered": "IDJ_oq_assistantContentRendered",
			"schemaDescription": "IDJ_oq_schemaDescription",
			"turnLabelActive": "IDJ_oq_turnLabelActive",
			"assistantToolCallText": "IDJ_oq_assistantToolCallText",
			"event": "IDJ_oq_event",
			"eventInner": "IDJ_oq_eventInner",
			"details": "IDJ_oq_details",
			"overviewTitleIcon": "IDJ_oq_overviewTitleIcon",
			"thinkingQuote": "IDJ_oq_thinkingQuote",
			"kindTag": "IDJ_oq_kindTag",
			"noPayload": "IDJ_oq_noPayload",
			"inlineResult": "IDJ_oq_inlineResult",
			"panelImageLinkPreview": "IDJ_oq_panelImageLinkPreview",
			"requestDetailsDot": "IDJ_oq_requestDetailsDot",
			"split": "IDJ_oq_split",
			"toolCallNameTypeface": "IDJ_oq_toolCallNameTypeface",
			"jsonPayload": "IDJ_oq_jsonPayload",
			"turnRail": "IDJ_oq_turnRail",
			"resultRequest": "IDJ_oq_resultRequest",
			"promptDiffLineremoved": "IDJ_oq_promptDiffLineremoved",
			"assistantToolCallsPreview": "IDJ_oq_assistantToolCallsPreview",
			"sourceBlockJumpTarget": "IDJ_oq_sourceBlockJumpTarget",
			"selectionRail": "IDJ_oq_selectionRail",
			"compactedSummary": "IDJ_oq_compactedSummary",
			"overviewHierarchyJumpIconTight": "IDJ_oq_overviewHierarchyJumpIconTight",
			"virtualSpacer": "IDJ_oq_virtualSpacer",
			"toolCatalogDescription": "IDJ_oq_toolCatalogDescription",
			"resultBlocksPreview": "IDJ_oq_resultBlocksPreview",
			"errorPayload": "IDJ_oq_errorPayload",
			"requestDetailsName": "IDJ_oq_requestDetailsName",
			"historyLoadRow": "IDJ_oq_historyLoadRow",
			"detailTabs": "IDJ_oq_detailTabs",
			"sourceBlocks": "IDJ_oq_sourceBlocks",
			"trajectory-table": "IDJ_oq_trajectory-table",
			"promptDiff": "IDJ_oq_promptDiff",
			"overviewParentLinks": "IDJ_oq_overviewParentLinks",
			"schemaPreview": "IDJ_oq_schemaPreview",
			"summaryScrollRegion": "IDJ_oq_summaryScrollRegion",
			"assistantToolCallName": "IDJ_oq_assistantToolCallName",
			"detailsLocation": "IDJ_oq_detailsLocation",
			"assistantToolCalls": "IDJ_oq_assistantToolCalls",
			"sourceBlockContent": "IDJ_oq_sourceBlockContent",
			"jsonPreview": "IDJ_oq_jsonPreview",
			"detailTabActive": "IDJ_oq_detailTabActive",
			"sourceBlockLabel": "IDJ_oq_sourceBlockLabel",
			"detailBodySummary": "IDJ_oq_detailBodySummary",
			"contentColumn": "IDJ_oq_contentColumn",
			"toolCatalogDefinition": "IDJ_oq_toolCatalogDefinition",
			"overview": "IDJ_oq_overview",
			"historyLoadingSpinner": "IDJ_oq_historyLoadingSpinner",
			"overviewSection": "IDJ_oq_overviewSection",
			"overviewHierarchyNavLink": "IDJ_oq_overviewHierarchyNavLink",
			"toolCatalogSummary": "IDJ_oq_toolCatalogSummary",
			"messageImages": "IDJ_oq_messageImages"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-trajectory/src/client/TrajectoryToolbar.module.css.mjs
		const css$2 = ".Se0HVa_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.Se0HVa_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.Se0HVa_actions{flex:none;align-items:center;gap:2px;display:flex}.Se0HVa_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.Se0HVa_toggle:hover,.Se0HVa_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.Se0HVa_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.Se0HVa_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.Se0HVa_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.Se0HVa_control[hidden]{display:none}.Se0HVa_control:hover:not(:disabled),.Se0HVa_control[aria-checked=true],.Se0HVa_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.Se0HVa_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.Se0HVa_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.Se0HVa_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.Se0HVa_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.Se0HVa_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.Se0HVa_controlTrack[data-on=true] .Se0HVa_controlThumb{transform:translate(10px)}.Se0HVa_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.Se0HVa_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.Se0HVa_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.Se0HVa_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.Se0HVa_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.Se0HVa_search:hover{border-color:var(--dsw-alias-label-caption)}.Se0HVa_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.Se0HVa_searchIcon{flex:none}.Se0HVa_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.Se0HVa_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.Se0HVa_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"root": "Se0HVa_root",
			"toggleIcon": "Se0HVa_toggleIcon",
			"action": "Se0HVa_action",
			"actions": "Se0HVa_actions",
			"controlThumb": "Se0HVa_controlThumb",
			"actionIcon": "Se0HVa_actionIcon",
			"controlTrack": "Se0HVa_controlTrack",
			"search": "Se0HVa_search",
			"searchIcon": "Se0HVa_searchIcon",
			"searchInput": "Se0HVa_searchInput",
			"toggle": "Se0HVa_toggle",
			"control": "Se0HVa_control",
			"inner": "Se0HVa_inner"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-trajectory/src/client/TrajectoryTimeline.module.css.mjs
		const css$1 = ".HxUAcW_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.HxUAcW_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.HxUAcW_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.HxUAcW_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.HxUAcW_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.HxUAcW_labels span:first-child{top:7px}.HxUAcW_labels span:nth-child(2){top:21px}.HxUAcW_labels span:nth-child(3){top:35px}.HxUAcW_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.HxUAcW_track[data-panning=true]{cursor:grabbing}.HxUAcW_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.HxUAcW_earlierHistory:hover{opacity:1}.HxUAcW_earlierHistory[aria-disabled=true]{cursor:default}.HxUAcW_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}.HxUAcW_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.HxUAcW_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.HxUAcW_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.HxUAcW_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.HxUAcW_lanes[data-animate-viewport=true],.HxUAcW_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.HxUAcW_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}.HxUAcW_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.HxUAcW_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.HxUAcW_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.HxUAcW_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.HxUAcW_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.HxUAcW_span[data-timeline-span=tool],.HxUAcW_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.HxUAcW_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.HxUAcW_span[data-equal-duration=true]{width:8px;min-width:8px}.HxUAcW_span[data-selected=false]{opacity:.2}.HxUAcW_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.HxUAcW_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.HxUAcW_span[data-search-match=false]{opacity:.14}.HxUAcW_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.HxUAcW_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.HxUAcW_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.HxUAcW_selectionEdges:before,.HxUAcW_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.HxUAcW_selectionEdges:before{left:0}.HxUAcW_selectionEdges:after{right:0}.HxUAcW_selectionEdges[data-dragging=true]:before,.HxUAcW_selectionEdges[data-dragging=true]:after{width:2px}.HxUAcW_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"root": "HxUAcW_root",
			"labels": "HxUAcW_labels",
			"selection": "HxUAcW_selection",
			"selectionEdges": "HxUAcW_selectionEdges",
			"empty": "HxUAcW_empty",
			"lanes": "HxUAcW_lanes",
			"track": "HxUAcW_track",
			"earlierHistory": "HxUAcW_earlierHistory",
			"plot": "HxUAcW_plot",
			"turnBoundaries": "HxUAcW_turnBoundaries",
			"turnBoundary": "HxUAcW_turnBoundary",
			"span": "HxUAcW_span",
			"hoverLine": "HxUAcW_hoverLine"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/dsh-harness/packages/client/ui-trajectory/src/client/views.module.css.mjs
		const css = "._8XNAPG_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}._8XNAPG_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
